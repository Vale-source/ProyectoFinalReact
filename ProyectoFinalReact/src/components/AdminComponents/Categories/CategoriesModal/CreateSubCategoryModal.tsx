...
const CreateSubCategoryModal: React.FC<CreateSubCategory> = ({
  onClose,
  fetchCategories,
  category,
}) => {
  ...
  const idCategoriaPadre = category.id;
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Confirmado!",
        text: `La subcategoria ${denominacion} ha sido creada con exito!`,
        background: "#313131",
        color: "white",
      });
      fetchCategories();
  ...
  return (
    <div
      ...
      <div
        ...
        <h2>Crear una subcategoria de {category.denominacion}</h2>
        <input
          style={{
            padding: "10px",
            borderRadius: "5px",
