    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <input type="text" placeholder="Ingresar una denominación" />
            <input type="text" placeholder="Categoría" />
            <input type="text" placeholder="Alergenos" />
            <input type="text" placeholder="Ingresa un precio de venta" />
            <input type="text" placeholder="Ingresa un codigo" />
            <div
              style={{
                width: "100%",
                borderRadius: "5px",
